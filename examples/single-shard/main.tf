...
module "cluster" {
  source = "github.com/nstance-dev/terraform-gcp-nstance//cluster"

  cluster_id = var.cluster_id
}

module "account" {
  source = "github.com/nstance-dev/terraform-gcp-nstance//account"

  cluster = module.cluster
}

module "network" {
  source = "github.com/nstance-dev/terraform-gcp-nstance//network"
...
module "shard" {
  source = "github.com/nstance-dev/terraform-gcp-nstance//shard"
